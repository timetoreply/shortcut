 ...
 */
class HistoryReferenceCommit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryReferenceCommit';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling HistoryReferenceCommit., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling HistoryReferenceCommit., must conform to the pattern /^https?:\/\/.+$/.");
        }
