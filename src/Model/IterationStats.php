 ...
 */
class IterationStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IterationStats';
    ...
    */
     ...
     *
     * @param int|null $averageCycleTime The average cycle time (in seconds) of completed stories in this Iteration.
     *
     * @return self
     */
     ...
     *
     * @param int|null $averageLeadTime The average lead time (in seconds) of completed stories in this Iteration.
     *
     * @return self
     */
