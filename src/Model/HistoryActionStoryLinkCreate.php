 ...
 */
class HistoryActionStoryLinkCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryActionStoryLinkCreate';
