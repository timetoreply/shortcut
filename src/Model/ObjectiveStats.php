...
/**
 * ObjectiveStats Class Doc Comment
 *
 * @category Class
 ...
 */
class ObjectiveStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectiveStats';
    ...
    */
     ...
     *
     * @param int|null $averageCycleTime The average cycle time (in seconds) of completed stories in this Objective.
     *
     * @return self
     */
     ...
     *
     * @param int|null $averageLeadTime The average lead time (in seconds) of completed stories in this Objective.
     *
     * @return self
     */
     ...
     *
     * @param int $numRelatedDocuments The number of related documents to this Objective.
     *
     * @return self
     */
