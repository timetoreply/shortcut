...
/**
 * CreateStoryFromTemplateParamsSubTasksInner Class Doc Comment
 *
 * @category Class
 * @package  Timetoreply\Shortcut
 * @author   OpenAPI Generator team
 ...
 */
class CreateStoryFromTemplateParamsSubTasksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStoryFromTemplateParams_sub_tasks_inner';
    ...
    */
     ...
     * Sets storyId
     *
     * @param int $storyId The ID of the story to link as a sub-task of the parent story
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStoryFromTemplateParamsSubTasksInner., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStoryFromTemplateParamsSubTasksInner., must be bigger than or equal to 1.');
        }
