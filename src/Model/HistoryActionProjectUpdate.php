...
/**
 * HistoryActionProjectUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoryActionProjectUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryActionProjectUpdate';
    ...
    */
    ...
    public function setAppUrl($appUrl)
    {
        ...
        if ((mb_strlen($appUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $appUrl when calling HistoryActionProjectUpdate., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($appUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$appUrl when calling HistoryActionProjectUpdate., must conform to the pattern /^https?:\/\/.+$/.");
        }
