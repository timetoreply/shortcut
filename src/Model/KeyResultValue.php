...
/**
 * KeyResultValue Class Doc Comment
 *
 * @category Class
 ...
 */
class KeyResultValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyResultValue';
    ...
    */
     ...
     * Sets numericValue
     *
     * @param string|null $numericValue The numeric value, as a decimal string. No more than two decimal places are allowed.
     *
     * @return self
     */
    public function setNumericValue($numericValue)
    {
        if (is_null($numericValue)) {
            throw new \InvalidArgumentException('non-nullable numericValue cannot be null');
        }
     ...
     * Sets booleanValue
     *
     * @param bool|null $booleanValue The boolean value.
     *
     * @return self
     */
