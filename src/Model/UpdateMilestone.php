 ...
 */
class UpdateMilestone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMilestone';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The Milestone's description.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateMilestone., must be smaller than or equal to 100000.');
        }
     ...
     * Sets archived
     *
     * @param bool|null $archived A boolean indicating whether the Milestone is archived or not
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $completedAtOverride A manual override for the time/date the Milestone was completed.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the Milestone.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateMilestone., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateMilestone., must be bigger than or equal to 1.');
        }
     ...
     * Sets state
     *
     * @param string|null $state The workflow state that the Milestone is in.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $startedAtOverride A manual override for the time/date the Milestone was started.
     *
     * @return self
     */
     ...
     * Sets categories
     *
     * @param \Timetoreply\Shortcut\Model\CreateCategoryParams[]|null $categories An array of IDs of Categories attached to the Milestone.
     *
     * @return self
     */
     ...
     * Sets beforeId
     *
     * @param int|null $beforeId The ID of the Milestone we want to move this Milestone before.
     *
     * @return self
     */
     ...
     * Sets afterId
     *
     * @param int|null $afterId The ID of the Milestone we want to move this Milestone after.
     *
     * @return self
     */
