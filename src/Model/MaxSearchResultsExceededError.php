 ...
 */
class MaxSearchResultsExceededError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaxSearchResultsExceededError';
    ...
    public const ERROR_MAXIMUM_RESULTS_EXCEEDED = 'maximum-results-exceeded';
    public const MAXIMUM_RESULTS_NUMBER_1000 = 1000;
    ...
    {
        return [
            self::MAXIMUM_RESULTS_NUMBER_1000,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('maximumResults', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['maximumResults']) && !in_array($this->container['maximumResults'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'maximumResults', must be one of '%s'",
                $this->container['maximumResults'],
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        if (is_null($maximumResults)) {
            throw new \InvalidArgumentException('non-nullable maximumResults cannot be null');
        }
        $allowedValues = $this->getMaximumResultsAllowableValues();
