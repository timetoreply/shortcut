...
/**
 * BaseTaskParams Class Doc Comment
 *
 * @category Class
 ...
 */
class BaseTaskParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseTaskParams';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BaseTaskParams., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BaseTaskParams., must be bigger than or equal to 1.');
        }
    ...
    public function setExternalId($externalId)
    {
        ...
        if ((mb_strlen($externalId) > 128)) {
            throw new \InvalidArgumentException('invalid length for $externalId when calling BaseTaskParams., must be smaller than or equal to 128.');
        }
