...
class UpdateFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFile';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateFile., must be smaller than or equal to 4096.');
        }
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt The time/date that the file was uploaded.
     *
     * @return self
     */
     ...
     * Sets updatedAt
     *
     * @param \DateTime|null $updatedAt The time/date that the file was last updated.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateFile., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateFile., must be bigger than or equal to 1.');
        }
     ...
     * Sets uploaderId
     *
     * @param string|null $uploaderId The unique ID assigned to the Member who uploaded the file to Shortcut.
     *
     * @return self
     */
     ...
     * Sets externalId
     *
     * @param string|null $externalId An additional ID that you may wish to assign to the file.
     *
     * @return self
     */
    public function setExternalId($externalId)
    {
        ...
        if ((mb_strlen($externalId) > 128)) {
            throw new \InvalidArgumentException('invalid length for $externalId when calling UpdateFile., must be smaller than or equal to 128.');
        }
