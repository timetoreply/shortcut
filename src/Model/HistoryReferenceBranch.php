...
/**
 * HistoryReferenceBranch Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoryReferenceBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryReferenceBranch';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling HistoryReferenceBranch., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling HistoryReferenceBranch., must conform to the pattern /^https?:\/\/.+$/.");
        }
