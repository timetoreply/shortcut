 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EpicStats implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'EpicStats';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lastStoryUpdate'] = isset($data['lastStoryUpdate']) ? $data['lastStoryUpdate'] : null;
     ...
     *
     * @param int $averageCycleTime The average cycle time (in seconds) of completed stories in this Epic.
     *
     * @return $this
     */
     ...
     *
     * @param int $averageLeadTime The average lead time (in seconds) of completed stories in this Epic.
     *
     * @return $this
     */
