 ...
 */
class HistoryReferenceStory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryReferenceStory';
    ...
    */
    ...
    public function setAppUrl($appUrl)
    {
        ...
        if ((mb_strlen($appUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $appUrl when calling HistoryReferenceStory., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($appUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$appUrl when calling HistoryReferenceStory., must conform to the pattern /^https?:\/\/.+$/.");
        }
