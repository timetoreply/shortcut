 ...
 */
class UpdateEpic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEpic';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateEpic., must be smaller than or equal to 100000.');
        }
     ...
     * Sets archived
     *
     * @param bool|null $archived A true/false boolean indicating whether the Epic is in archived state.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The Epic's name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateEpic., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateEpic., must be bigger than or equal to 1.');
        }
     ...
     * Sets followerIds
     *
     * @param string[]|null $followerIds An array of UUIDs for any Members you want to add as Followers on this Epic.
     *
     * @return self
     */
     ...
     * Sets ownerIds
     *
     * @param string[]|null $ownerIds An array of UUIDs for any members you want to add as Owners on this Epic.
     *
     * @return self
     */
    ...
    public function setExternalId($externalId)
    {
        ...
        if ((mb_strlen($externalId) > 128)) {
            throw new \InvalidArgumentException('invalid length for $externalId when calling UpdateEpic., must be smaller than or equal to 128.');
        }
     ...
     * Sets beforeId
     *
     * @param int|null $beforeId The ID of the Epic we want to move this Epic before.
     *
     * @return self
     */
     ...
     * Sets afterId
     *
     * @param int|null $afterId The ID of the Epic we want to move this Epic after.
     *
     * @return self
     */
