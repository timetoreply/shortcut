 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateStoryLinkParams implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CreateStoryLinkParams';
    /**
     ...
     * Sets subjectId
     *
     * @param int $subjectId The unique ID of the Story defined as subject.
     *
     * @return $this
     */
     ...
     * Sets objectId
     *
     * @param int $objectId The unique ID of the Story defined as object.
     *
     * @return $this
     */
