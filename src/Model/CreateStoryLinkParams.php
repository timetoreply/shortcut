...
/**
 * CreateStoryLinkParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateStoryLinkParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStoryLinkParams';
    ...
    */
     ...
     * Sets subjectId
     *
     * @param int|null $subjectId The unique ID of the Story defined as subject.
     *
     * @return self
     */
     ...
     * Sets objectId
     *
     * @param int|null $objectId The unique ID of the Story defined as object.
     *
     * @return self
     */
