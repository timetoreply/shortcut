 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StoryContents implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'StoryContents';
     ...
     * Sets externalLinks
     *
     * @param string[] $externalLinks An array of external links connected to the story.
     *
     * @return $this
     */
     ...
     * Sets tasks
     *
     * @param StoryContentsTask[] $tasks An array of tasks connected to the story.
     *
     * @return $this
     */
     ...
     * Sets groupId
     *
     * @param string $groupId The ID of the group to which the story is assigned.
     *
     * @return $this
     */
