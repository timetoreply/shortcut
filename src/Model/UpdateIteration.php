...
/**
 * UpdateIteration Class Doc Comment
 *
 * @category Class
 * @package  Timetoreply\Shortcut
 * @author   OpenAPI Generator team
 ...
 */
class UpdateIteration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateIteration';
    ...
    */
     ...
     * Sets groupIds
     *
     * @param string[]|null $groupIds An array of UUIDs for any Groups you want to add as Followers. Currently, only one Group association is presented in our web UI.
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param \Timetoreply\Shortcut\Model\CreateLabelParams[]|null $labels An array of Labels attached to the Iteration.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the Iteration.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateIteration., must be smaller than or equal to 100000.');
        }
     ...
     * Sets name
     *
     * @param string|null $name The name of this Iteration
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateIteration., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateIteration., must be bigger than or equal to 1.');
        }
     ...
     * Sets startDate
     *
     * @param string|null $startDate The date this Iteration begins, e.g. 2019-07-01
     *
     * @return self
     */
    public function setStartDate($startDate)
    {
        ...
        if ((mb_strlen($startDate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $startDate when calling UpdateIteration., must be bigger than or equal to 1.');
        }
     ...
     * Sets endDate
     *
     * @param string|null $endDate The date this Iteration ends, e.g. 2019-07-05.
     *
     * @return self
     */
    public function setEndDate($endDate)
    {
        ...
        if ((mb_strlen($endDate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling UpdateIteration., must be bigger than or equal to 1.');
        }
