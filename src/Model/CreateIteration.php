 ...
 */
class CreateIteration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateIteration';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateIteration., must be smaller than or equal to 100000.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateIteration., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateIteration., must be bigger than or equal to 1.');
        }
    ...
    public function setStartDate($startDate)
    {
        ...
        if ((mb_strlen($startDate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $startDate when calling CreateIteration., must be bigger than or equal to 1.');
        }
    ...
    public function setEndDate($endDate)
    {
        ...
        if ((mb_strlen($endDate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling CreateIteration., must be bigger than or equal to 1.');
        }
