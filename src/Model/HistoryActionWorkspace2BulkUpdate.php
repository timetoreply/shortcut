 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HistoryActionWorkspace2BulkUpdate implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = null;
    const ACTION_BULK_UPDATE = 'bulk-update';
    /**
     * The original name of the model.
     *
     * @var string
     */
    protected static $swaggerModelName = 'HistoryActionWorkspace2BulkUpdate';
    /**
