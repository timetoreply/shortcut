...
class Label implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'externalId' => 'string',
        'id' => 'int',
        'stats' => '\Timetoreply\Shortcut\Model\LabelStats',
        'createdAt' => '\DateTime'
    ];
    ...
    */
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (mb_strlen($color) < 1)) {
            throw new \InvalidArgumentException('invalid length for $color when calling Label., must be bigger than or equal to 1.');
        }
        if (!is_null($color) && (!preg_match("/^#[a-fA-F0-9]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling Label., must conform to the pattern /^#[a-fA-F0-9]{6}$/.");
        }
     ...
     * Gets stats
     *
     * @return \Timetoreply\Shortcut\Model\LabelStats|null
     */
     ...
     * Sets stats
     *
     * @param \Timetoreply\Shortcut\Model\LabelStats|null $stats stats
     *
     * @return self
     */
