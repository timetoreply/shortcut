...
/**
 * HistoryReferencesInner Class Doc Comment
 *
 * @category Class
 * @package  Timetoreply\Shortcut
 * @author   OpenAPI Generator team
 ...
 */
class HistoryReferencesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'History_references_inner';
    ...
    public const TYPE_UNSTARTED = 'unstarted';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling HistoryReferencesInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling HistoryReferencesInner., must conform to the pattern /^https?:\/\/.+$/.");
        }
    ...
    public function setAppUrl($appUrl)
    {
        ...
        if ((mb_strlen($appUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $appUrl when calling HistoryReferencesInner., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($appUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$appUrl when calling HistoryReferencesInner., must conform to the pattern /^https?:\/\/.+$/.");
        }
     ...
     * Sets description
     *
     * @param string $description The description of the Story Task.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Either \"backlog\", \"unstarted\", \"started\", or \"done\".
     *
     * @return self
     */
