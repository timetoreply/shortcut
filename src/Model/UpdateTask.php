    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateTask., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateTask., must be bigger than or equal to 1.');
        }
     ...
     * Sets complete
     *
     * @param bool|null $complete A true/false boolean indicating whether the task is complete.
     *
     * @return self
     */
     ...
     * Sets beforeId
     *
     * @param int|null $beforeId Move task before this task ID.
     *
     * @return self
     */
     ...
     * Sets afterId
     *
     * @param int|null $afterId Move task after this task ID.
     *
     * @return self
     */
