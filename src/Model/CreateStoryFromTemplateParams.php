...
/**
 * CreateStoryFromTemplateParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateStoryFromTemplateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStoryFromTemplateParams';
    ...
    protected static $openAPITypes = [
        ...
        'linkedFileIdsRemove' => 'int[]',
        'requestedById' => 'string',
        'iterationId' => 'int',
        'customFieldsRemove' => '\Timetoreply\Shortcut\Model\RemoveCustomFieldParams[]',
        ...
        'projectId' => 'int',
        'linkedFileIdsAdd' => 'int[]',
        'linkedFileIds' => 'int[]',
        'labelsRemove' => '\Timetoreply\Shortcut\Model\RemoveLabelParams[]',
        'deadline' => '\DateTime',
        'ownerIdsAdd' => 'string[]',
        'createdAt' => '\DateTime',
        'externalLinksRemove' => 'string[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'projectId' => 'int64',
        'linkedFileIdsAdd' => 'int64',
        'linkedFileIds' => 'int64',
        'labelsRemove' => null,
        'deadline' => 'date-time',
        'ownerIdsAdd' => 'uuid',
        'createdAt' => 'date-time',
        'externalLinksRemove' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'epicId' => true,
        'storyTemplateId' => false,
        'externalLinks' => false,
        'followerIdsRemove' => false,
        'subTasks' => false,
        'linkedFileIdsRemove' => false,
        'requestedById' => false,
        'iterationId' => true,
        ...
        'projectId' => true,
        'linkedFileIdsAdd' => false,
        'linkedFileIds' => false,
        'labelsRemove' => false,
        'deadline' => true,
        'ownerIdsAdd' => false,
        'createdAt' => false,
        'externalLinksRemove' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'labels' => 'labels',
        'externalLinksAdd' => 'external_links_add',
        ...
        'name' => 'name',
        'fileIdsAdd' => 'file_ids_add',
        'fileIdsRemove' => 'file_ids_remove',
        'comments' => 'comments',
        ...
        'subTasks' => 'sub_tasks',
        'linkedFileIdsRemove' => 'linked_file_ids_remove',
    ...
    protected static $setters = [
        ...
        'labels' => 'setLabels',
        'externalLinksAdd' => 'setExternalLinksAdd',
        ...
        'name' => 'setName',
        'fileIdsAdd' => 'setFileIdsAdd',
        'fileIdsRemove' => 'setFileIdsRemove',
        ...
        'linkedFileIdsRemove' => 'setLinkedFileIdsRemove',
    ...
    protected static $getters = [
        ...
        'labels' => 'getLabels',
        'externalLinksAdd' => 'getExternalLinksAdd',
        ...
        'name' => 'getName',
        'fileIdsAdd' => 'getFileIdsAdd',
        'fileIdsRemove' => 'getFileIdsRemove',
        ...
        'linkedFileIdsRemove' => 'getLinkedFileIdsRemove',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('externalLinksAdd', $data ?? [], null);
        ...
        $this->setIfExists('fileIdsAdd', $data ?? [], null);
        $this->setIfExists('fileIdsRemove', $data ?? [], null);
        ...
        $this->setIfExists('linkedFileIdsRemove', $data ?? [], null);
        ...
        $this->setIfExists('linkedFileIdsAdd', $data ?? [], null);
        ...
        $this->setIfExists('externalLinksRemove', $data ?? [], null);
    }
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateStoryFromTemplateParams., must be smaller than or equal to 100000.');
        }
    ...
    /**
     * Gets externalLinksAdd
     *
     * @return string[]|null
     */
    public function getExternalLinksAdd()
    {
        return $this->container['externalLinksAdd'];
    }

    /**
     * Sets externalLinksAdd
     *
     * @param string[]|null $externalLinksAdd An array of External Links associated with this story. These will be added to any links provided by the template. Cannot be used in conjunction with `external_links`.
     *
     * @return self
     */
    public function setExternalLinksAdd($externalLinksAdd)
    {
        if (is_null($externalLinksAdd)) {
            throw new \InvalidArgumentException('non-nullable externalLinksAdd cannot be null');
        }


        $this->container['externalLinksAdd'] = $externalLinksAdd;
     ...
     * Sets name
     *
     * @param string|null $name The name of the story. Must be provided if the template does not provide a name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStoryFromTemplateParams., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStoryFromTemplateParams., must be bigger than or equal to 1.');
        }
     ...
     * @return int[]|null
     */
    public function getFileIdsAdd()
    {
        return $this->container['fileIdsAdd'];
    }

    /**
     * Sets fileIdsAdd
     *
     * @param int[]|null $fileIdsAdd An array of IDs of files attached to the story in addition to files from the template. Cannot be used in conjunction with `file_ids`.
     *
     * @return self
     */
    public function setFileIdsAdd($fileIdsAdd)
    {
        if (is_null($fileIdsAdd)) {
            throw new \InvalidArgumentException('non-nullable fileIdsAdd cannot be null');
        }


        $this->container['fileIdsAdd'] = $fileIdsAdd;
     ...
     * @return int[]|null
     */
    public function getFileIdsRemove()
    {
        return $this->container['fileIdsRemove'];
    }

    /**
     * Sets fileIdsRemove
     *
     * @param int[]|null $fileIdsRemove An array of IDs of files removed from files from the template. Cannot be used in conjunction with `file_ids`.
     *
     * @return self
     */
    public function setFileIdsRemove($fileIdsRemove)
    {
        if (is_null($fileIdsRemove)) {
            throw new \InvalidArgumentException('non-nullable fileIdsRemove cannot be null');
        }


        $this->container['fileIdsRemove'] = $fileIdsRemove;
     ...
     * Sets followerIdsAdd
     *
     * @param string[]|null $followerIdsAdd The UUIDs of the new followers to be added in addition to followers from the template. Cannot be used in conjunction with `follower_ids.`
     *
     * @return self
     */
     ...
     *
     * @param string $storyTemplateId The id of the story template used to create this story.
     *
     * @return self
     */
    public function setStoryTemplateId($storyTemplateId)
    {
        if (is_null($storyTemplateId)) {
            throw new \InvalidArgumentException('non-nullable storyTemplateId cannot be null');
        }
     ...
     *
     * @param string[]|null $followerIdsRemove The UUIDs of the new followers to be removed from followers from the template. Cannot be used in conjunction with `follower_ids`.
     *
     * @return self
     */
    ...
    /**
     * Gets linkedFileIdsRemove
     *
     * @return int[]|null
     */
    public function getLinkedFileIdsRemove()
    {
        return $this->container['linkedFileIdsRemove'];
    }

    /**
     * Sets linkedFileIdsRemove
     *
     * @param int[]|null $linkedFileIdsRemove An array of IDs of linked files removed from files from the template. Cannot be used in conjunction with `linked_files.`
     *
     * @return self
     */
    public function setLinkedFileIdsRemove($linkedFileIdsRemove)
    {
        if (is_null($linkedFileIdsRemove)) {
            throw new \InvalidArgumentException('non-nullable linkedFileIdsRemove cannot be null');
        }


        $this->container['linkedFileIdsRemove'] = $linkedFileIdsRemove;
     ...
     *
     * @return \Timetoreply\Shortcut\Model\RemoveCustomFieldParams[]|null
     */
     ...
     *
     * @param \Timetoreply\Shortcut\Model\RemoveCustomFieldParams[]|null $customFieldsRemove A map specifying a CustomField ID. These will be removed from any fields provided by the template. Cannot be used in conjunction with `custom_fields`.
     *
     * @return self
     */
     ...
     * Sets labelsAdd
     *
     * @param \Timetoreply\Shortcut\Model\CreateLabelParams[]|null $labelsAdd An array of labels attached to the story in addition to the labels provided by the template. Cannot be used in conjunction with `labels`.
     *
     * @return self
     */
    ...
    public function setExternalId($externalId)
    {
        ...
        if ((mb_strlen($externalId) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $externalId when calling CreateStoryFromTemplateParams., must be smaller than or equal to 1024.');
        }
     ...
     * Sets ownerIdsRemove
     *
     * @param string[]|null $ownerIdsRemove The UUIDs of the new owners to be removed from owners from the template. Cannot be used in conjunction with `owners`.
     *
     * @return self
     */
     ...
     *
     * @param \Timetoreply\Shortcut\Model\CustomFieldValueParams[]|null $customFieldsAdd A map specifying a CustomField ID and CustomFieldEnumValue ID that represents an assertion of some value for a CustomField. These will be added to any fields provided by the template. Cannot be used in conjunction with `custom_fields`.
     *
     * @return self
     */
    ...
    /**
     * Gets linkedFileIdsAdd
     *
     * @return int[]|null
     */
    public function getLinkedFileIdsAdd()
    {
        return $this->container['linkedFileIdsAdd'];
    }

    /**
     * Sets linkedFileIdsAdd
     *
     * @param int[]|null $linkedFileIdsAdd An array of IDs of linked files attached to the story in addition to files from the template. Cannot be used in conjunction with `linked_files`.
     *
     * @return self
     */
    public function setLinkedFileIdsAdd($linkedFileIdsAdd)
    {
        if (is_null($linkedFileIdsAdd)) {
            throw new \InvalidArgumentException('non-nullable linkedFileIdsAdd cannot be null');
        }


        $this->container['linkedFileIdsAdd'] = $linkedFileIdsAdd;
     ...
     * Gets labelsRemove
     *
     * @return \Timetoreply\Shortcut\Model\RemoveLabelParams[]|null
     */
     ...
     * Sets labelsRemove
     *
     * @param \Timetoreply\Shortcut\Model\RemoveLabelParams[]|null $labelsRemove An array of labels to remove from the labels provided by the template. Cannot be used in conjunction with `labels`.
     *
     * @return self
     */
     ...
     * Sets ownerIdsAdd
     *
     * @param string[]|null $ownerIdsAdd The UUIDs of the new owners to be added in addition to owners from the template. Cannot be used in conjunction with `owners`.
     *
     * @return self
     */
    ...
    /**
     * Gets externalLinksRemove
     *
     * @return string[]|null
     */
    public function getExternalLinksRemove()
    {
        return $this->container['externalLinksRemove'];
    }

    /**
     * Sets externalLinksRemove
     *
     * @param string[]|null $externalLinksRemove An array of External Links associated with this story. These will be removed from any links provided by the template. Cannot be used in conjunction with `external_links`.
     *
     * @return self
     */
    public function setExternalLinksRemove($externalLinksRemove)
    {
        if (is_null($externalLinksRemove)) {
            throw new \InvalidArgumentException('non-nullable externalLinksRemove cannot be null');
        }


        $this->container['externalLinksRemove'] = $externalLinksRemove;
