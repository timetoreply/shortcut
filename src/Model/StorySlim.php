 ...
 */
class StorySlim implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorySlim';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['numTasksCompleted'] === null) {
            $invalidProperties[] = "'numTasksCompleted' can't be null";
        }
        ...
        if ($this->container['linkedFileIds'] === null) {
            $invalidProperties[] = "'linkedFileIds' can't be null";
        }
        ...
        if ($this->container['commentIds'] === null) {
            $invalidProperties[] = "'commentIds' can't be null";
        }
