...
/**
 * HistoryActionStoryUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoryActionStoryUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryActionStoryUpdate';
    ...
    protected static $openAPITypes = [
        ...
        'action' => 'string',
        'appUrl' => 'string',
        'changes' => '\Timetoreply\Shortcut\Model\HistoryChangesStory',
        'name' => 'string',
        'storyType' => 'string'
    ];
    ...
    */
    ...
    public function setAppUrl($appUrl)
    {
        ...
        if ((mb_strlen($appUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $appUrl when calling HistoryActionStoryUpdate., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($appUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$appUrl when calling HistoryActionStoryUpdate., must conform to the pattern /^https?:\/\/.+$/.");
        }
     ...
     * Gets changes
     *
     * @return \Timetoreply\Shortcut\Model\HistoryChangesStory|null
     */
     ...
     * Sets changes
     *
     * @param \Timetoreply\Shortcut\Model\HistoryChangesStory|null $changes changes
     *
     * @return self
     */
