...
/**
 * HistoryReferenceProject Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoryReferenceProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryReferenceProject';
    ...
    */
     ...
     * Sets appUrl
     *
     * @param string $appUrl The application URL of the Project.
     *
     * @return self
     */
    public function setAppUrl($appUrl)
    {
        ...
        if ((mb_strlen($appUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $appUrl when calling HistoryReferenceProject., must be smaller than or equal to 2048.');
        }
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($appUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$appUrl when calling HistoryReferenceProject., must conform to the pattern /^https?:\/\/.+$/.");
        }
