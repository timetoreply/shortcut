...
/**
 * HistoryActionBranchCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class HistoryActionBranchCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoryActionBranchCreate';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the VCS Branch that was pushed
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The URL from the provider of the VCS Branch that was pushed
     *
     * @return self
     */
